...
import type { LeaderboardEntry, PersonalStats, Profile } from '../lib/supabase';
...
type ModeFilter = CanonMode | 'all-modes';

export function LeaderboardPanel({ profile, onBack }: LeaderboardPanelProps) {
    ...
    >
      ...
      {tab === 'platform' && (
        <div className="mode-filter">
          {(['all-modes', 'all', 'ot', 'nt'] as ModeFilter[]).map((m) => (
            <button
              key={m}
              type="button"
