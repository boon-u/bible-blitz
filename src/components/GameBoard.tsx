    ...
    <div className="game-board">
      ...
      <AnimatePresence mode="wait">
        {round.lastFeedback && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
          >
            {round.lastFeedback === 'correct' ? '✨ Perfect direction!' : '😅 Wrong way — points deducted'}
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <div className="direction-controls">
        ...
        >
          ...
          {leftBook && (
            <span className="dir-preview">toward {leftBook.abbr}</span>
          )}
        </motion.button>
        ...
        >
          ...
          {rightBook && (
            <span className="dir-preview">toward {rightBook.abbr}</span>
          )}
        </motion.button>
      </div>
